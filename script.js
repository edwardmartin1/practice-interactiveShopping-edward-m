...
buttonAddItem.addEventListener("click", () => {
    ...
    if (itemTextValue !== "")
    {
		...
		//const items = document.querySelectorAll("#unordered-list-item li span");
...
//-		newLiElement.appendChild(newTextBoxElement);
		...
		newRemoveButtonElement.addEventListener("click", (event) => {
		    //alert("Action performed for this item");
...
/*
		    const listItem = event.target.parentElement;
                    ...
                    if (newEditButtonElement.textContent === "Edit")
                    {
                        const newTextBoxElement = document.createElement("input");
                        newTextBoxElement.type = "text";
                        newTextBoxElement.value = span.textContent;
